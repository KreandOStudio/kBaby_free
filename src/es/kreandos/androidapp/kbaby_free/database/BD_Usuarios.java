...
import es.kreandos.androidapp.kbaby_free.krypto.SimpleKrypto;

public class BD_Usuarios {// extends Activity {
	...
	static final String nombre_Base_Datos = "DBUsuariosFree";
...
//	}
	public void creamosBD (Context contexto, int cod, String usuario, String email, String pass, String otroDato){
		//Abrimos la base de datos 'DBUsuariosPay' en modo escritura
		usdbh =	new UsuariosSQLiteHelper(contexto, nombre_Base_Datos, null, 1);
	...
	public int devuelveUltimoCodigo(Context con) {
		usdbh =	new UsuariosSQLiteHelper(con, nombre_Base_Datos, null, 1);
