...
public class MedicamSQLiteHelper extends SQLiteOpenHelper {
 ...
 * ***********************************************************************
 */
    String sqlCreate = "CREATE TABLE Medicamentos (codigo INTEGER, nom_medica TEXT, prin_activo TEXT, "
    		+ "dosis NUMERIC, horas INTEGER, observaciones TEXT)";
 /***********************************************************************
  * 
  * @param contexto
  * @param nombre
  ...
  * @param version
  */
    public MedicamSQLiteHelper(Context contexto, String nombre,
