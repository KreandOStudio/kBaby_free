 ...
 * ***********************************************************************
 */
    String sqlCreate = "CREATE TABLE Termometro (cod_pac INTEGER, temperatura NUMERIC, "
    		+ "fecha INTEGER, hora INTEGER, medicamento TEXT, obsercaciones TEXT)";
 /***********************************************************************
  * 
  * @param contexto
  * @param nombre
  ...
  * @param version
  */
    public TermoSQLiteHelper(Context contexto, String nombre,
    ...
    public void onUpgrade(SQLiteDatabase db, int versionAnterior, int versionNueva) {
        ...
        db.execSQL("DROP TABLE IF EXISTS Termometro");
