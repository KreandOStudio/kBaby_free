...
import es.kreandos.androidapp.kbaby_free.database.DBAdapter;
...
// Creamos el menu desde el archivo XML
	 ...
	 *   resultCode es el codigo de retorno, 0 significa que todo salio bien
	...
	private void fillData() {
		...
		SimpleCursorAdapter notes = new SimpleCursorAdapter(this, R.layout.row, cursor,
				from, to);
